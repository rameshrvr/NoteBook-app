...
class UserProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post user_profiles_url, params: { user_profile: { email: @user_profile.email, name: @user_profile.name, password: 'secret', password_confirmation: 'secret' } }
    end
  ...
  test "should update user_profile" do
    patch user_profile_url(@user_profile), params: { user_profile: { email: @user_profile.email, name: @user_profile.name, password: 'secret', password_confirmation: 'secret' } }
